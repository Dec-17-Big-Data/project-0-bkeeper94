...
public class BankAccountServiceTests {
	...
	public void getBankAccountTest() throws NoSuchElementException {
		...
		assertTrue(bas.getBankAccount(accountNoToTest) != null);
	...
	public void performTransferTest() throws OverDrawException, NoSuchElementException{
		...
		assertEquals(expected1, bas.performTransfer(ba.get(1).getAccountNo(), 
		...
		assertEquals(expected2, bas.performTransfer(ba.get(1).getAccountNo(), 
		...
		assertEquals(expected3, bas.performTransfer(ba.get(1).getAccountNo(), 
				"0000000000", 100.00));
	}
